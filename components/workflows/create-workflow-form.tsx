...
export function CreateWorkflowForm() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        toast({
          title: "Lỗi",
          description: error.message || "Không thể tải dữ liệu cần thiết cho luồng phê duyệt.",
          variant: "destructive",
        })
      } finally {
  ...
  const handleStepChange = async (index: number, field: string, value: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Thành công",
        description: "Luồng phê duyệt đã được tạo thành công!",
      })
      ...
      toast({
        title: "Lỗi",
        description: error.message || "Có lỗi xảy ra khi tạo luồng phê duyệt.",
        variant: "destructive",
      })
    } finally {
      setIsLoading(false)
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-gradient-to-br from-blue-50 to-white rounded-lg shadow-sm">
      <Card className="bg-gradient-to-br from-gray-50 to-white hover:shadow-lg transition-shadow duration-300">
        <CardHeader>
          <CardTitle className="text-blue-800">Tạo luồng phê duyệt mới</CardTitle>
        </CardHeader>
        <CardContent>
          {isLoadingData ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button
                ...
                disabled={isLoading}
              >
                <ButtonLoading isLoading={isLoading} loadingText="Đang tạo luồng...">
                  Tạo luồng phê duyệt
                </ButtonLoading>
              </Button>
            </form>
